...
import { ExecutionVersion, debugPrefix, defaultInngestApiBaseUrl, defaultInngestEventBaseUrl, defaultMaxRetries, dummyEventKey, envKeys, forwardedHeaders, headerKeys, internalEvents, logPrefix, probe, queryKeys, syncKind } from "../helpers/consts.js";
import { AsyncResponseType, StepMode, StepOpCode, functionConfigSchema, inBandSyncRequestBodySchema, logLevels } from "../types.js";
import { PREFERRED_ASYNC_EXECUTION_VERSION, PREFERRED_CHECKPOINTING_EXECUTION_VERSION } from "./execution/InngestExecution.js";
import { rethrowError, serializeError } from "../helpers/errors.js";
import { fetchAllFnData, parseFnData, undefinedToNull, versionSchema } from "../helpers/functions.js";
...
var RequestSignature = class {
	...
	async #verifySignature({ body, signingKey, allowExpiredSignatures }) {
		...
		if (await signDataWithKey(body, signingKey, this.timestamp) !== this.signature) throw new Error("Invalid signature");
	}
