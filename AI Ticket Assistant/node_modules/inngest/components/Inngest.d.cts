import { AsArray, IsNever, SendEventPayload, SimplifyDeep, SingleOrArray, WithoutInternal } from "../helpers/types.cjs";
import { EventSchemas } from "./EventSchemas.cjs";
import { InngestFunctionReference } from "./InngestFunctionReference.cjs";
import { ExtendWithMiddleware, InngestMiddleware } from "./InngestMiddleware.cjs";
...
import { ClientOptions, EventNameFromTrigger, EventPayload, FailureEventArgs, Handler, IncomingOp, InvokeTargetFunctionDefinition, OutgoingOp, SendEventOutput, TriggersFromClient } from "../types.cjs";
...
declare namespace Inngest {
  ...
  type EndpointHandler<TClient extends Inngest.Any> = ReturnType<NonNullable<ClientOptionsFromInngest<TClient>["endpointAdapter"]>>;
