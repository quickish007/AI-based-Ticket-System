...
import { ExecutionVersion, headerKeys, internalEvents } from "../../helpers/consts.js";
...
import { createDeferredPromise, createDeferredPromiseWithStack, createTimeoutPromise, goIntervalTiming, resolveAfterPending, runAsPromise } from "../../helpers/promises.js";
		...
		*/
		const reportNextTick = () => {
			...
			foundStepsReportPromise = resolveAfterPending().then(() => beforeExecHooksPromise).then(() => {
				...
				for (const [hashedId, step] of unhandledFoundStepsToReport) if ((this.options.stepMode === StepMode.Async || step.hasStepState) && step.handle()) {
